          ...
          <RSelect.Viewport className="p-1">
            {options.map((opt) => (
              <RSelect.Item
                ...
                className="flex cursor-pointer items-center justify-between gap-2 rounded-sm px-2.5 py-1.5 text-sm text-text outline-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 data-[highlighted]:bg-surface-muted data-[state=checked]:font-medium"
              >
